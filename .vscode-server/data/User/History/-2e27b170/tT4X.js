...
@@ -24,41 +24,32 @@ const getPartyById = async (id) => {
  try {
...
@@ -104,7 +95,7 @@ const renderSinglePartyById = async (id) => {
...
@@ -133,19 +124,37 @@ const renderParties = async (parties) => {
...
@@ -155,7 +164,8 @@ const renderParties = async (parties) => {
